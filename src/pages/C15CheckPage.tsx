...
const categories = [
  {
    name: '服務現現',
    items: [
      '當班人員服儀清潔：符合服儀海報規範，頭髮需整齊（長髮盤起）、手部不得佩戴戒指等飾品、手部若有傷口應進行包紮；不得著破鞋、內搭衣下擺不外露。',
  ...
  },
  {
    name: '櫃台區',
    items: [
      '桌面 >90公分購物空間（非臨面銷售）且乾淨整齊（含TM、六格陳列架等）；若櫃台長度 <90公分，不擺放面銷籃。',
      '後檯台淨空、除店用設備外無放置其他物品且保持乾淨；不放置私人用品（飲料、手機）、雜物等。',
      '洗手台僅可放置洗手乳、菜瓜布可放內側；蔗架上方淨空、除專用捕蠅紙陳列盒。',
    ],
  },
  {
    name: 'FF區',
    items: [
      'FF區整齊清潔無空架：桌面無積塵、機台清潔、熱食器具、備品區（包包、袋子、壓克力架）無明顯髒污。',
      '防塵罩、壓克力架無嚴重泛黃破損，保溫石無嚴重糖蜜沾黏。',
      '販售時間內不可空架，賣相不佳商品需下架。',
    ],
  },
  {
    name: '全店貨架',
    items: [
      '商品排面整齊無缺品；4℃（含中島櫃）、18℃、麵包架、鮮食OC、WI、全店貨架及層板保持乾淨、無灰塵、污漬、水氣。',
      '定時清潔貨架縫隙、轉角與底層積塵，避免蚊蟲屋、包裝碎屑等污染源。',
      '中島櫃上方不堆放雜物。',
    ],
  },
  {
  ...
  },
  {
    name: '客用空間',
    items: [
      '休憩區清潔：桌面／地面清潔無髒污無垃圾，桌貼無髒污、破損，垃圾桶乾淨無滿溢。',
      '客用廁所清潔：垃圾桶無滿溢、廁所無異味、地面／洗手台清潔。',
      '自助服務機台：結帳機、咖啡機、微波爐等，環境保持清潔。',
    ],
  },
]
