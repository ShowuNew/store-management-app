...
import { CheckCircle2, Circle, Thermometer, Save, AlertCircle } from 'lucide-react'
      ...
      <div className="px-4 py-4 space-y-4 pb-8">
                  ...
                  {tasks.map((task, i) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <span
                          className="text-sm"
                          style={{ color: done ? '#059669' : '#374151', textDecoration: done ? 'line-through' : 'none' }}
                        >
                          {task}
                        </span>
                      </motion.button>
        ...
        {!submitted ? (
          ...
          <div className="w-full py-4 rounded-2xl bg-green-50 border border-green-100 text-center">
            ...
            <p className="text-green-400 text-xs mt-0.5">{new Date().toLocaleTimeString('zh-TW')}</p>
          </div>
        )}
      </div>
    </div>
